          ...
          <div>
            ...
            >
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item v-if="scope.row.master" command="masterTaskUp"
                  >新建主任务(在上)</el-dropdown-item
                >
                <el-dropdown-item
                  v-if="scope.row.master"
                  command="masterTaskDown"
                  >新建主任务(在下)</el-dropdown-item
                >
                <el-dropdown-item command="sonTask"
          ...
          tableData.forEach((item, index) => {
            ...
            if (!item.id.includes(".")) {
              ...
              if (index === 0) {
                ...
                item.id = `${item.id.slice(0, item.id.length - 1)}${
                  +tableData[index - 1].id.slice(
